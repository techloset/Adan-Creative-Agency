                ...
                <div className="mx-[24px] lg:mx-[80px] xl:mx-[160px] py-[100px] lg:py-[200px] relative">
                    <div className="rounded-[20px] text-white bg-exact-yellow text-center pt-16 pb-[84px]">
                        ...
                        <div className="flex justify-center">
                            <button className={`shadow-2xl shadow-exact-red/50 md:max-w-fit py-[19px] px-[42.5px] bg-[#4C40F7] rounded-xl `}>
                                <span className="flex items-baseline">
                                    <p className="text-base font-semibold leading-[26px] text-white">Start Now</p>
                            ...
                            <div className="text-center rounded-[20px]  bg-[#4C40F7] pt-[60px] pb-[80px]">
                                ...
                                <div className="flex justify-center">
                                    <div className="flex justify-center text-black/75 items-center w-fit relative">
                                        ...
                                        <Image width={150} height={150} src="/send.png" alt="" className="w-[19px] h-[18px] absolute right-12" />
                                    </div>
                                </div>
                            </div>
                        </div>

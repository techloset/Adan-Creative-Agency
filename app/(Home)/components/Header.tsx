        ...
        <>
            <div className={`bg-center  ${openMenu ? styles.bgNavbar : null}`}>
                <nav className={`mx-[24px] lg:mx-[80px]  xl:mx-[160px] flex flex-col md:flex-row justify-between items-center ${!openMenu ? "h-[160px]" : "h-screen"} `}>
                    <div className={`flex w-full md:max-w-fit justify-between items-center ${openMenu ? "border-b-2" : "border-none"} border-black/25 dark:border-white pb-4 md:border-none `}>
                        <Image
                            src="/Logo.svg"
                            alt="Logo"
                            width={100}
                        ...
                        />
                        <div onClick={() => setOpenMenu(openMenu === false ? true : false)} className="md:hidden">
                            <Image
                    ...
                    <ul className={`flex flex-col items-center md:space-x-20 space-y-10 ${!openMenu ? "invisible md:visible" : "visible"} md:space-y-0 mt-10 md:mt-0 h-screen md:h-auto md:flex-row`} >
                        <li className={` text-exact-purple dark:text-exact-yellow text-xl  hover:text-exact-purple  dark:hover:text-exact-yellow`}>Home</li>
                        <li className={` text-exact-gray dark:text-white text-xl  hover:text-exact-purple  dark:hover:text-exact-yellow`}>Work</li>
                        <li className={`text-exact-gray dark:text-white text-xl  hover:text-exact-purple  dark:hover:text-exact-yellow`}>About</li>
                    </ul>
